...
import { BookOpen, ChartNoAxesCombined, ChevronsLeft, ChevronsRight, Code2, GraduationCap, Home, Settings, Workflow } from 'lucide-vue-next'
...
<template>
  <div :class="['app-shell', { 'onboarding-shell': route.path === '/onboarding', 'rail-expanded': railExpanded && route.path !== '/onboarding' }]">
    ...
    <aside v-if="route.path !== '/onboarding'" :class="['activity-rail', { expanded: railExpanded }]" :aria-expanded="railExpanded">
